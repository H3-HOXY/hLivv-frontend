                                ...
                                <ul id="dropdown-shopping" className="py-2 space-y-2">
                                    ...
                                    <li>
                                        <a href="/mypage/buydetail"
                                           className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">구매내역</a>
                                    </li>
                                    <li>
                  ...
                  <a href="/mypage/myrestoredetail" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">리스토어내역</a>
                                    ...
                                    <li>
                                        <a href="/mypage/coupon"
                                           className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">쿠폰함</a>
                                    </li>
                                </ul>
                            )}
                        </li>
